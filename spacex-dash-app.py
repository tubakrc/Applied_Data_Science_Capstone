...
# TASK 1: Create a dropdown list of unique launch sites
...
app.layout = html.Div(children=[
    ...
    # TASK 3: Add a RangeSlider for payload mass
...
# TASK 4: Callback to update scatter chart based on site and payload slider
@app.callback(
